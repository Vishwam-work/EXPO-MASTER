...
import Consignee_table from '../../components/Tables/Consignee_table';
const Consignee=()=>{
    return(
    <div className='setting-head'>
      ...
      <div className="settingcontainer">
        ...
        <h1 style={{ color: "#3E4AB6", fontSize: "28px", marginBottom: "20px" }}>Consignee</h1>
        <div style={{marginBottom: "50px" }}>

        <span style={{ color: "#3E4AB6", fontSize: "28px", }}>Add Consignee : <ConsigneeModal/></span>
        </div>
