# Generated by Django 4.0.5 on 2023-12-14 19:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Bldraft',
            fields=[
                ('blno', models.CharField(max_length=100, primary_key=True, serialize=False)),
                ('bldate', models.DateField(blank=True, null=True)),
                ('invoiceno', models.CharField(max_length=100)),
                ('invociedate', models.DateField(blank=True, default='None', null=True)),
